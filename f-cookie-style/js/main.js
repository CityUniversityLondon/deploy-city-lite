...
const ie = (0,_util__WEBPACK_IMPORTED_MODULE_2__.detectIE)();
class Carousel {
  ...
  activeSlider(index, sliders) {
    let a = (0,_util__WEBPACK_IMPORTED_MODULE_2__.toArray)(sliders.querySelectorAll('.swiper-slide'));
    a.forEach(e => {
  ...
  totalSliderWidth(e) {
    const sliders = (0,_util__WEBPACK_IMPORTED_MODULE_2__.toArray)(this.checkEventType(e).querySelectorAll('.swiper-slide'));
    let totalWidth = 0;
    sliders.forEach(s => {
...
function launchArrow(slider) {
  ...
  if (1 >= slides.length) {
    (0,_util__WEBPACK_IMPORTED_MODULE_2__.removeClass)(slider, className, false);
    return;
...
function launchDot(slider) {
  ...
  slides.forEach((slide, i) => {
    ...
    let dot = (0,_util__WEBPACK_IMPORTED_MODULE_2__.createHTMLElement)('button', [{
      label: 'data-page',
      val: i
    }, {
      label: 'aria-label',
    ...
    if (i === 0) {
      // Active slide
      dot.setAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_3__["default"].current, 'slide');
