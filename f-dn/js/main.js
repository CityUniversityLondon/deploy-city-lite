...
function axiosRequest(config) {
  ...
  return axios__WEBPACK_IMPORTED_MODULE_2___default()(config).then(response => {
    ...
    if (!axios__WEBPACK_IMPORTED_MODULE_2___default().isCancel(e)) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["core","axios"], () => (__webpack_require__("./src/main.js")))
